...
while pagina_atual <= 10:
    ...
    for div in divs:
        ...
        #colocando o nome da página ; link da página
with open("Resultadosrobog.txt", "w")as arquivo:
    for resultado in lista_resultados:
        arquivo.write(f"{resultado}\n")
    arquivo.close


print(f"{len(lista_resultados)} resultados encontrados do Google e salvos no arquivos resultadosrobog.txt")        